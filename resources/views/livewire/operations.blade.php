                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Operations  </h6>
                        </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation" wire:ignore>
                                        <button class="nav-link active " id="home-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="home-tab-pane" aria-selected="true"><span
                                                class="fw-bold">Deposit</span> </button>
                                    </li>
                                    <li class="nav-item" role="presentation" wire:ignore>
                                        <button wire:click="resetInput()" class="nav-link" id="profile-tab"
                                            data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button"
                                            role="tab" aria-controls="profile-tab-pane" aria-selected="false"><span
                                    ...
                                    <li class="nav-item" role="presentation" wire:ignore>
                                        <button class="nav-link" id="disabled-tab" data-bs-toggle="tab"
                                            ...
                                            aria-controls="disabled-tab-pane" aria-selected="false"><span
                                                class="fw-bold">Currency
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                        aria-labelledby="home-tab" tabindex="0" wire:ignore.self>
                                        <div class="row mt-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    bg-gradient-primary shadow-primary @endif
                                                            shadow text-center border-radius-lg">
                                                                    <i
                                                                        class="material-icons opacity-10">account_balance</i>
                                                                </div>

                                                            </div>
                                                            <div class="card-body pt-0 p-3 text-center">
                                                                @if ($this->currency)
                                                                    <h6 class="text-center mb-0"> {{ $this->currency }}
                                                                    </h6>
                                                                @else
                                                        ...
                                                        <div class="card">
                                                            <div class="card-header mx-4 p-3 text-center">
                                                                <div
                                                                    ...
                                                                    <i
                                                                        class="material-icons opacity-10">account_balance_wallet</i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <form wire:submit.prevent="deposit">
                                                        <div class="card-header pb-0 p-3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 text-end">
                                                                    <button type="submit"
                                                                        class="btn bg-gradient-dark mb-0"><i
                                                        ...
                                                        <div class="card-body p-3">
                                                            <div class="col-md-12 mb-md-0 mb-4">
                                                                <input type="text"
                                                                    class="form-control fw-bold px-3"
                                    ...
                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
                                        aria-labelledby="profile-tab" tabindex="0" wire:ignore.self>
                                        <div class="row mt-3">
                                            <div class="col-xl-6 mb-xl-0 mb-4 ">
                                                <div class="card bg-transparent shadow-xl">
                                                    <div class="overflow-hidden position-relative border-radius-xl">
                                    ...
                                    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel"
                                        aria-labelledby="contact-tab" tabindex="0" wire:ignore.self>
                                        <div class="row mt-4">
                                                ...
                                                <div class="card bg-transparent shadow-xl">
                                                    <div class="overflow-hidden position-relative border-radius-xl">
                                                        ...
                                                        <div class="card-body position-relative z-index-1 p-3">
                                                            ...
                                                            <h6 class="text-white mt-2 mb-0 pb-2 "
                                                    ...
                                                    <div class="col-md-6 col-6">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body pt-0 p-3 text-center">
                                                                ...
                                                                <select wire:click="fromAccount()"
                                                                    wire:model.defer="fromAccount" class="form-select"
                                                    ...
                                                    <div class="col-md-6 col-6">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body pt-0 p-3 text-center">
                                                                ...
                                                                <select wire:click="toAccount()"
                                                                    wire:model.defer="toAccount" class="form-select"
                                                                    size="3" aria-label="size 3 select example">
                                                                    @foreach ($accounts as $account)
                                                                        <option
                                                                            value="{{ $account->account_number }}">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="row ">
                                                    ...
                                                    bg-gradient-primary shadow-primary 
                                                            ...
                                                            <div class="card-body pt-0 p-3 text-center">
                                                                <h6 class="text-center mb-0">{{ $this->fromCurrency }}
                                                                </h6>
                                                    ...
                                                    <div class="col-md-6 col-6">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body pt-0 p-3 text-center">
                                                                <h6 class="text-center mb-0">{{ $this->toCurrency }}
                                                                </h6>
                                                    ...
                                                    <form wire:submit.prevent="exchange">
                                                        <div class="card-header pb-0 p-3">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 text-end">
                                                                    <div wire:loading wire:target="exchange"
                                                                        wire:key="exchange"><i
                                                                            class="fa fa-spinner fa-spin  ml-2"
                                                                            style="color: #A10000;  font-size: 19px;"></i>
                                                                    </div>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                                    <button type="submit"
                                    ...
                                    <div class="card-body p-3 pb-0">
                                        <ul class="list-group">
                                            ...
                                            <li
                                                class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                                <div class="d-flex flex-column">
                                                    <h6 class="text-dark mb-1 font-weight-bold text-sm">April, 05, 2020
                                                    </h6>
                                            ...
                                            <li
                                                class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                                <div class="d-flex flex-column">
                                                    <h6 class="text-dark mb-1 font-weight-bold text-sm">June, 25, 2019
                                                    </h6>
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex flex-column">
                                                    <h6 class="text-dark mb-1 font-weight-bold text-sm">March, 01, 2019
                                                    </h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 mt-4">
                                <div class="card h-100 mb-4">
                                    ...
                                    <div class="card-body pt-4 p-3">
                                        <h6 class="text-uppercase text-body text-xs font-weight-bolder mb-3">Newest
                                        </h6>
                                        <ul class="list-group">
                                            <li
                                                class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                        ...
                                        <h6 class="text-uppercase text-body text-xs font-weight-bolder my-3">Yesterday
                                        </h6>
                                        <ul class="list-group">
                                            <li
                                                class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
